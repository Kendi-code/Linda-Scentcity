...
# CHANGED: 'portfolio_project.urls' -> 'core.urls'
...
# CHANGED: 'portfolio_project.wsgi.application' -> 'core.wsgi.application'
...
if CLOUDINARY_CLOUD_NAME:
    import cloudinary
    # Cloudinary apps must be added here if triggered dynamically
